...
def row_gen(load_file=WORKBOOK_DEFAULT, sheet_range_min=min_range, sheet_range_max=max_range):
    ...
    for sheet in sheets:
        ...
        data1, data2 = worksheet['C3'].value, worksheet['D3'].value
    return i_row, data1, data2
...
if __name__ == '__main__':
    ...
    try:
        ...
        rows, data1, data2 = row_gen(argv[1], 'A4', 'J8')
    except:
        rows, data1, data2 = row_gen(WORKBOOK_DEFAULT, 'B4', 'J999')
